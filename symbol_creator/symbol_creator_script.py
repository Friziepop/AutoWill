...
def create(params: SymbolParams, models_dir: str = MODELS_DIR, materials_db: str = MATERIALS_DB):
    ...
    footprint_params = FootprintParams(
        macro_path="C:\\Users\\Mike\\Documents\\AutoWill\\orcad\\pcb_automation\\wil_symbol_macro.scr",
        dxf_file=os.path.join(out_path, "out.dxf"),
        dxf_mapping_file="C:\\Users\\Mike\\Documents\\AutoWill\\orcad\\pcb_automation\\resources\\mapping_setup.cnv",
        ...
        draw_path="C:\\Users\\Mike\\Documents\\AutoWill\\orcad\\package\\wil_sym.dra",
